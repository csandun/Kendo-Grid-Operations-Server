...
namespace QueryDesignerCore
{
    ...
    public static class QueryableExtensions
    {
        ...
        public static IOrderedQueryable<T> OrderBy<T>(this IQueryable<T> query, SortDescriptor filter)
        {
        ...
        /// <exception cref="InvalidOperationException" />
        /// <returns>Sorted query.</returns>
        public static IOrderedQueryable<T> OrderBy<T>(this IEnumerable<T> query, SortDescriptor filter)
        {
        ...
        /// <exception cref="InvalidOperationException" />
        /// <returns>Sorted query.</returns>
        public static IOrderedQueryable<T> ThenBy<T>(this IQueryable<T> query, SortDescriptor filter)
        {
        ...
        /// <exception cref="InvalidOperationException" />
        /// <returns>Sorted query.</returns>
        public static IOrderedQueryable<T> ThenBy<T>(this IEnumerable<T> query, SortDescriptor filter)
        {
        ...
        /// <exception cref="InvalidOperationException" />
        /// <returns>Sorted query.</returns>
        public static IOrderedQueryable<T> OrderBy<T>(this IQueryable<T> query, IEnumerable<SortDescriptor> filters)
        {
        ...
        /// <exception cref="InvalidOperationException" />
        /// <returns>Sorted query.</returns>
        public static IOrderedQueryable<T> OrderBy<T>(this IEnumerable<T> query, IEnumerable<SortDescriptor> filters)
        {
